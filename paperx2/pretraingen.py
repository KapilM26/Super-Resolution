...
if __name__ == "__main__":
    ...
    generator.fit_generator(
        load_inputs(str('/kaggle/input/celeba-dataset/img_align_celeba/img_align_celeba/'),
                    str('/kaggle/input/celeba-dataset/img_align_celeba/img_align_celeba/')),
        steps_per_epoch=1000,
        epochs=10,
        callbacks=[ModelCheckpoint(
            filepath='/kaggle/working/{epoch:02d}.hdf5')],
