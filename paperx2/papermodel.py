...
generator = load_model(
    '/kaggle/input/pretrained-srgan-generator/pretrained.hdf5')
...
for e in range(1, epochs+1):
    ...
    pr = pr.astype(int)
    cv2.imwrite('/kaggle/working/epoch_gen_imgs/prsrp'+str(e)+'.jpg', pr)
    ...
    if e % 5 == 0:
        generator.save(
            '/kaggle/working/checkpoint_models/srpgeneratorep'+str(e)+'.hdf5')
        discriminator.save(
            '/kaggle/working/checkpoint_models/srpdiscriminatorep'+str(e)+'.hdf5')
        if os.path.exists('/kaggle/working/checkpoint_models/srpgeneratorep'+str(e-10)+'.hdf5'):
            os.remove(
                '/kaggle/working/checkpoint_models/srpgeneratorep'+str(e-10)+'.hdf5')
            os.remove(
                '/kaggle/working/checkpoint_models/srpdiscriminatorep'+str(e-10)+'.hdf5')
generator.save('/kaggle/working/srpgenerator.hdf5')
discriminator.save('/kaggle/working/srpdiscriminator.hdf5')
